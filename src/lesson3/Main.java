...
//        System.out.println(Arrays.toString(arrInt));
        ...
        В psvm вызвать метод printInfo дважды с разными значениями
         */
//        printInfo(5, 7);
//        printInfo(1, -100);
        ...
        В psvm вызвать метод threeDoubleProduct со значениями 0.001, 1000 и -1.257, вывести результат на экран
         */
